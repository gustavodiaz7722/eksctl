...
func (in *AccessEntry) DeepCopyInto(out *AccessEntry) {
	*out = *in
	out.PrincipalARN = in.PrincipalARN
...
func (in *AutoModeConfig) DeepCopyInto(out *AutoModeConfig) {
	*out = *in
	...
	out.NodeRoleARN = in.NodeRoleARN
	if in.NodePools != nil {
...
func (in *ClusterConfig) DeepCopyInto(out *ClusterConfig) {
	*out = *in
	...
	if in.IAMIdentityMappings != nil {
		in, out := &in.IAMIdentityMappings, &out.IAMIdentityMappings
	...
	if in.KubernetesDataEncryption != nil {
		in, out := &in.KubernetesDataEncryption, &out.KubernetesDataEncryption
		*out = new(KubernetesDataEncryption)
		**out = **in
	}
	if in.Status != nil {
...
func (in CustomStringSlice) DeepCopyInto(out *CustomStringSlice) {
	{
		in := &in
		*out = make(CustomStringSlice, len(*in))
		copy(*out, *in)
		return
	}
}
...
func (in *IAMStatement) DeepCopyInto(out *IAMStatement) {
	*out = *in
	if in.Principal != nil {
		...
		*out = make(map[string]CustomStringSlice, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
				(*out)[key] = nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesDataEncryption) DeepCopyInto(out *KubernetesDataEncryption) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesDataEncryption.
func (in *KubernetesDataEncryption) DeepCopy() *KubernetesDataEncryption {
	if in == nil {
		return nil
	}
	out := new(KubernetesDataEncryption)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeGroupNodeRepairConfig) DeepCopyInto(out *NodeGroupNodeRepairConfig) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeGroupNodeRepairConfig.
...
func (in *PodIdentityAssociation) DeepCopyInto(out *PodIdentityAssociation) {
	*out = *in
	if in.PermissionPolicyARNs != nil {
		in, out := &in.PermissionPolicyARNs, &out.PermissionPolicyARNs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	in.PermissionPolicy.DeepCopyInto(&out.PermissionPolicy)
	out.WellKnownPolicies = in.WellKnownPolicies
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make(map[string]string, len(*in))
